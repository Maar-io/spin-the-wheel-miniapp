...
export const SpinToWin: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      {/* Wheel Section: pointer overlaps wheel by ~half (negative margin) */}
      <div style={{
        display: 'flex',
        flexDirection: 'column',
        alignItems: 'center',
        ...
        {/* Pointer overlaps wheel by ~half (40px pointer, -20px = half over wheel) */}
      ...
      {/* Bottom Section - compact so Spin + Rules fit in frame */}
      <div style={{
        display: 'flex',
        width: '100%',
        maxWidth: '280px',
        ...
        {targetAnimalIndex !== null && (
          <div style={{
            ...
            🧪 TEST: Expected {ZODIAC_ANIMALS[targetAnimalIndex]} (index: {targetAnimalIndex})
          </div>
        )}
      </div>
    </div>
